...
regexHooks = dict( # A dictionary which holds the regex that then trigger each core command. 
                  ...
                  ModifyStatus =       re.compile(r'(Rescue|Destroy|Return|BringToPlay|Exile|Capture|SendToBottom|Commit|Uncommit|Engage|Disengage|Sacrifice|Attack|Takeover)(Target|Multiple|Host)'),
